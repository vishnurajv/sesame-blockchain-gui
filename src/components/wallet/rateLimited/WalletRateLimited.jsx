...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const sesameper_input = ip_parsed.limit;
    ...
    const sesameper_value = Number.parseInt(Number(sesameper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (sesame per interval):{' '}
                  {mojo_to_sesame_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
